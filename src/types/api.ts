...
export class Convert {
  public static toWelcome(json: string): APISpaceXResponse {
    return cast(JSON.parse(json), r("Welcome"));
  }

  public static welcomeToJson(value: APISpaceXResponse): string {
...
const typeMap: any = {
  ...
  Doc: o(
    [
      ...
      { json: "static_fire_date_utc", js: "static_fire_date_utc", typ: Date },
      { json: "static_fire_date_unix", js: "static_fire_date_unix", typ: 0 },
  ...
  Failure: o(
    [
      ...
      { json: "altitude", js: "altitude", typ: null },
